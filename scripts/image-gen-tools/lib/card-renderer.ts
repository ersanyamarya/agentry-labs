...
// Terminal-green palette chosen for Agentry Labs (the repo has no brand tokens of its own).
export const THEME: Theme = {
  primary: 'oklch(0.8 0.19 150)',
  background: 'oklch(0.15 0.012 160)',
  foreground: 'oklch(0.96 0.01 150)',
  muted: 'oklch(0.66 0.03 155)',
  surface: 'oklch(0.19 0.014 160)',
  fontDisplay: "'JetBrains Mono', ui-monospace, SFMono-Regular, monospace",
  fontBody: "'Inter', ui-sans-serif, system-ui, sans-serif",
  fontMono: "'JetBrains Mono', ui-monospace, SFMono-Regular, monospace",
  fontsHref: 'https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;600;700&family=Inter:wght@400;500&display=swap',
};

/** 1280x640 is the README / GitHub social preview size. */
